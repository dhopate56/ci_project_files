                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="number" class="form-control" id="" name="pincode" placeholder="Enter Your First Name">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input type="number" class="form-control" id="" name="delivery_charge" placeholder="Enter Your First Name">
                                                        <label for="floatingFirstnameInput">delivery_charge </label>
                                                    </div>
