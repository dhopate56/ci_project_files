                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="index.php/Category" class="waves-effect">
                                    <i class="uim uim-airplay"></i>
                                    <span>category</span>
                                </a>
                            </li>
                              <li>
                                <a href="index.php/settings/pincode" class="waves-effect">
                                    <i class="uim uim-airplay"></i>
                                    <span>pincode</span>
                                </a>
                            </li>
                             <li>
                                <a href="index.php/settings/banner" class="waves-effect">
                                    <i class="uim uim-airplay"></i>
                                    <span>banner</span>
                                </a>
                            </li>  
                            <li>
                                <a href="index.php/Product" class="waves-effect">
                                    <i class="uim uim-airplay"></i>
                                    <span>product</span>
                                </a>
                            </li>
